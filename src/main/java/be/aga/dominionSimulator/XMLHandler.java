    ...
    public void startElement(String uri, String localName, String qName, Attributes attribs) {
        ...
        if (localName.equals("playerCollection")) {
            ...
            stack.push(new DomPlayer(resolveAttrib(uri, "name", attribs, null),
                    resolveAttrib(uri, "author", attribs, null), resolveAttrib(uri, "description", attribs, null)));
            ...
            ((DomPlayer) stack.peek()).addBoard(resolveAttrib(uri, "contents", attribs, null),
                    resolveAttrib(uri, "bane", attribs, null), resolveAttrib(uri, "Mountain_Pass_Bid", attribs, null),
                    resolveAttrib(uri, "Obelisk_Choice", attribs, null),
                    resolveAttrib(uri, "Shelters", attribs, "false"));
            ...
            ((StartState) stack.peek()).addDrawDeck(resolveAttrib(uri, "contents", attribs, null),
                    resolveAttrib(uri, "shuffle", attribs, null));
            ...
            ((DomPlayer) stack.peek()).addPlayStrategy(resolveAttrib(uri, "name", attribs, null),
                    resolveAttrib(uri, "strategy", attribs, null));
            stack.push(new DomBuyRule(resolveAttrib(uri, "name", attribs, null),
                    resolveAttrib(uri, "strategy", attribs, null), resolveAttrib(uri, "bane", attribs, null)));
        } else if (localName.equals("condition")) {
            stack.push(new DomBuyCondition());
        } else if (localName.equals("left")) {
            ((DomBuyCondition) stack.peek()).addLeftHand(resolveAttrib(uri, "type", attribs, null),
                    resolveAttrib(uri, "attribute", attribs, null));
            ...
            ((DomBuyCondition) stack.peek()).addRightHand(resolveAttrib(uri, "type", attribs, null),
                    resolveAttrib(uri, "attribute", attribs, null));
        } else if (localName.equals("extra_operation")) {
            ((DomBuyCondition) stack.peek()).addExtraOperation(resolveAttrib(uri, "type", attribs, null),
                    resolveAttrib(uri, "attribute", attribs, null));
        } else {
            // do nothing
        }
