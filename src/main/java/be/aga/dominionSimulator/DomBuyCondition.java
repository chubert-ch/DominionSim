...
public class DomBuyCondition {
    ...
    public DomBuyCondition(DomBotFunction aLeftFunction, DomCardName aLeftCardName, DomCardType aLeftCardType,
            String aLeftValue, DomBotComparator aComparator, DomBotFunction aRightFunction, DomCardName aRightCardName,
            DomCardType aRightCardType, String aRightValue, DomBotOperator anExtraOperator, String anExtraAttribute) {
    ...
    public String getXML(String theRuleIndentation) {
        ...
        if (rightFunction==DomBotFunction.countCardsInDeck
                ...
                || rightFunction == DomBotFunction.countCardsInHand || rightFunction == DomBotFunction.countCardsInPlay
