...
public class DomBoardChooser extends EscapeDialog implements ActionListener {
    ...
    private JPanel getSelectionPanel() {
        ...
        thePanel.setLayout(new GridBagLayout());
        final GridBagConstraints theCons = DomGui.getGridBagConstraints(2);
        JScrollPane theCardNamePane = new JScrollPane(getCardNameList(), JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
        ...
        theCons.gridx++;
        JScrollPane theBotPane = new JScrollPane(getBoardList(), JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
                JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
