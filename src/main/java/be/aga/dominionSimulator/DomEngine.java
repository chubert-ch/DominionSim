...
public class DomEngine {
    ...
    private void createSimpleCardStrategiesBots() {
        for (DomCardName theCard : DomCardName.getSafeValues()) {
            if (theCard.hasCardType(DomCardType.Kingdom) && !theCard.hasCardType(DomCardType.Ruins)) {
    ...
    public boolean loadCurrentUserBots() {
        ...
        if (BOT_FILE.exists() && BOT_FILE.isFile()) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(myGui, "Error Reading File", "error", JOptionPane.ERROR_MESSAGE);
            }
            return false;
        }
        return true;
    ...
    public void saveCurrentUserBots() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(myGui, "Error Writing File", "error", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    public void saveUserBots() {
        ...
        if (fileChooser.showSaveDialog(myGui) == JFileChooser.APPROVE_OPTION) {
            Writer output = null;
            try {
                String theWriteFile = fileChooser.getCurrentDirectory().getAbsolutePath() + "\\";
    ...
    public void loadUserBots() {
        ...
        if (fileChooser.showOpenDialog(myGui) == JFileChooser.APPROVE_OPTION) {
            Reader input = null;
            try {
                String theReadFile = fileChooser.getCurrentDirectory().getAbsolutePath() + "\\";
    ...
    public DomPlayer[] getBots(List<DomBotType> domBotTypes, String[] keywords) {
        ...
        player: for (DomPlayer player : bots) {
            ...
            if (keywords != null) {
                keyword: for (String searchKeyword : keywords) {
