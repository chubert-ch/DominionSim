        ...
        if (isTaggedByHerbalist() || isTaggedByScheme()) {
            if (getName() == DomCardName.Hermit && owner.getBoughtCards().isEmpty()) {
                if (owner.isHumanOrPossessedByHuman()) {
                    if (owner.getEngine().getGameFrame().askPlayer(
                            "<html>Trash " + DomCardName.Hermit.toHTML() + " ? (Scheme interaction!!)</html>",
                            "Resolving " + this.getName().toString()))
                        if (shapeshifterCard != null)
                            owner.trash(shapeshifterCard);
                        else if (estateCard != null)
                            owner.trash(estateCard);
                        else
                            owner.trash(this);
                    else if (shapeshifterCard != null)
